...
// Obvious non-stream chrome to drop.
const NOISE = /\b(facebook|twitter|telegram|discord|reddit|instagram|whatsapp|youtube|login|sign[\s-]?up|register|donate|dmca|contact|privacy|terms|about|home)\b/i;
